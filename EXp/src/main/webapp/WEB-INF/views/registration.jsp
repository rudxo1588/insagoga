                ...
                <td><table width="640" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr align="center" bgcolor="F8F8F8"> 
                      <td height="26" align="center" bgcolor="#E4EBF1" style="padding-right:10"><table width="600" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td align="center"><strong>교육정보 |자격증. 보유기술정보 |프로젝트정보 | 
                              경력정보 |근무정보 </strong></td>
                          </tr>
                        </table></td>
                    </tr>
                        ...
                        <tr>
                          ...
                          <td width="456"><table width="423" border="0" cellspacing="2" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <td height="26"><input type="text" name="CNAME"></td>
                            </tr>
                            <tr>
                              <td height="26" align="right"><strong>주민등록번호 :</strong>&nbsp;</td>
                              <td height="26"><input name="BNUMBER" type="text" size="15">
      -
        <input name="BNUMBER1" type="text" size="15"></td>
                            </tr>
                          </table></td>
                        </tr>
                      </table></td>
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="526" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="391"><input type="file" name="MImg">
                      ...
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="391"><input name="YEAR" type="text" size="10">
                              ...
                              일 ( 
                              <input type="radio" name="BIRTH" value="양력">
                              양력 
                              <input type="radio" name="BIRTH" value="음력">
                              음력 )</td>
                          </tr>
                        </table></td>
                    </tr>
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="391"> <input type="radio" name="MERRY"  value="미혼">
                              미혼 
                              <input type="radio" name="MERRY"  value="기혼">
                              기혼</td>
                          </tr>
                        </table></td>
                    </tr>
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"> <select name="SALARY">
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"> <select name="CONDITION">
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"><input name="ADDRESS" type="text" size="40"> 
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"><input name=PHONE type="text" size="35">
                              </td>
                          </tr>
                        </table></td>
                    </tr>
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"><input name="GRADE" type="text" size="20"> 
                            </td>
                          </tr>
                        </table></td>
                    </tr>
        ...
        <tr>
          <td height="3" align="center"><table width="107" border="0" cellpadding="1" cellspacing="1">
            <tr>
              <td width="49"><button>등록</button></td>
              <td width="51"><a href="javascript:history.go(-1)"><img src="image/bt_cancel.gif" width="49" height="18"></a></td>
            </tr>
          </table> </td>
        </tr>
        <tr> 
